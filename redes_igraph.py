...
G1 = Graph()
G1 = G1.Barabasi(n=10000, m=5, outpref=True, directed=False, power=3, zero_appeal=1, implementation="psumtree", start_from=None)

# Obtengo lista de adyacencia
ady_list_BA = G1.get_edgelist()

# Guardo lista de adyacencia en archivo .txt
F = open("igraph-networks/BA.txt", "w") 
...
G2 = Graph()
G2 = G2.Erdos_Renyi(n=10000, p=0.20, directed=False, loops=False)

# Obtengo lista de adyacencia
ady_list_ER = G2.get_edgelist()

# Guardo lista de adyacencia en archivo .txt
F = open("igraph-networks/ER.txt", "w") 
...
# Guardo lista de adyacencia en archivo .txt
F = open("igraph-networks/WS.txt", "w") 

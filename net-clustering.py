...
for i in lst:
	...
	#print(p.sizes())
	#print(len(p))
	J = open(cwd+'/com-fastgreedy-inter_H-Y_I.txt', 'w') 
	...
	p = C.as_clustering() #Cuts dendrogram at the given level (optimal) and returns a VertexClustering object.
	print(len(p))
	J = open(cwd+'/com-edge_betweenness-inter_H-Y.txt', 'w') 
	J.write ('#communities= '+str(len(p))+'\n')
	for i in range(len(p)):
		J.write ('C'+str(i+1)+' '+str(p[i])+'\n')
	J.close()
	...
	p = C.membership
	print(len(p))
	J = open(cwd+'/com-optimal_modularity-inter_H-Y.txt', 'w') 
	J.write ('#communities= '+str(len(p))+'\n')
	...
	p = C.as_clustering()
	print(len(p))
	J = open(cwd+'/com-walktrap-inter_H-Y.txt', 'w') 
	J.write ('#communities= '+str(len(p))+'\n')
	for i in range(len(p)):
		J.write ('C'+str(i+1)+' '+str(p[i])+'\n')
	J.close()
	...
	p = C.membership
	print(len(p))
	J = open(cwd+'/com-spinglass-inter_H-Y.txt', 'w') 
	J.write ('#communities= '+str(len(p))+'\n')
	for i in range(G.vcount()):
		J.write (str(i+1)+' '+str(p[i])+'\n')
	J.close()
	...
	p = C.membership
	print(len(p))
	J = open(cwd+'/com-infomap-inter_H-Y.txt', 'w') 
	J.write ('#communities= '+str(len(p))+'\n')
	for i in range(G.vcount()):
		J.write (str(i+1)+' '+str(p[i])+'\n')
	J.close()
	...
	p = C.membership
	print(len(p))
	J = open(cwd+'/com-label_propagation-inter_H-Y.txt', 'w') 
	J.write ('#communities= '+str(len(p))+'\n')
	for i in range(G.vcount()):
		J.write (str(i+1)+' '+str(p[i])+'\n')
	J.close()
	...
	p = C.membership
	print(len(p))
	J = open(cwd+'/com-leading_eigenvector-inter_H-Y.txt', 'w') 
	J.write ('#communities= '+str(len(p))+'\n')
	for i in range(G.vcount()):
		J.write (str(i+1)+' '+str(p[i])+'\n')
	J.close()
	...
	for u in c:
		print(len(u))
	J = open(cwd+'/com-fastgreedy-inter_H-Y_NX.txt', 'w') 
